          ...
          <>
            ...
            {onCourseRoute && (
              <>
                ...
                <Button
                  variant={path.includes(`/courses/${courseId}/chats`) ? "default" : "ghost"}
                  className="flex items-center gap-2 w-full sm:w-auto justify-center"
            ...
            {!isMobile && isAuthenticated && (
              <DropdownMenu>
                ...
                >
                  <DropdownMenuItem
                    className="cursor-pointer px-3 py-2 text-sm hover:bg-accent rounded-md"
                    onClick={() => navigate(`/instructors/${currentInstructorId}/profile`)}
                  >
                    Profile
                  </DropdownMenuItem>
                  ...
                  <DropdownMenuItem
                    className="cursor-pointer px-3 py-2 text-sm hover:bg-accent rounded-md"
                    onClick={() => navigate(`/instructors/${currentInstructorId}/courses`)}
                  >
                    Courses
                  </DropdownMenuItem>

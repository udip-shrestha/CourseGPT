...
\restrict xoRdvYRLqDVkLnKq1sg4jQr1ievhX9sf2aOeCTLx4ZwcSNZjoq9QeWNcp9nWAuI
...
COPY public.courses (id, name, institution, year, created_at, updated_at, instructor_id, semester_id, rag_strategy_id) FROM stdin;
\.
...
COPY public.documents (id, course_id, file_name, file_type_id, file_data, uploaded_at) FROM stdin;
\.
...
COPY public.file_types (id, mime_type, extension) FROM stdin;
...
--
-- Data for Name: instructor_roles; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.instructor_roles (id, role_name) FROM stdin;
1	ADMIN
2	INSTRUCTOR
\.
...
COPY public.instructors (id, name, email, password, university, title, created_at, updated_at, role_id) FROM stdin;
1c5554ed-6b27-4b5e-9dc3-7341ffc51cd0	Dr. Sarah Johnson	sarah.johnson@techuni.edu	$argon2id$v=19$m=65536,t=3,p=4$AE3fMBD/0KKpaXfT9a2nKQ$sUkLF+lmKJIUXUaokbRJvV2V0KSKdYb8XNJ5j4Jauao	Tech University	Associate Professor of Computer Science	2025-11-17 18:29:38.448114	2025-11-17 18:29:38.448114	2
501c9e79-7b40-46f9-b98a-30aa0984d54b	Admin	course_gpt@admin.edu	$argon2id$v=19$m=65536,t=3,p=4$AE3fMBD/0KKpaXfT9a2nKQ$sUkLF+lmKJIUXUaokbRJvV2V0KSKdYb8XNJ5j4Jauao	CourseGPT	System Administrator	2025-11-17 18:29:38.448114	2025-11-17 18:29:38.448114	1
\.
...
COPY public.queries (id, student_id, course_id, query_text, response_text, asked_at) FROM stdin;
\.


--
-- Data for Name: rag_strategies; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.rag_strategies (id, type_name, class_name, description) FROM stdin;
1	SIMPLE	SimpleRAGStrategy	Basic RAG pipeline: retrieve â†’ build prompt â†’ generate
2	AGENTIC	AgenticRAGStrategy	Agentic RAG using tools and multi-step reasoning
\.
...
COPY public.student_courses (student_id, course_id, registered_at) FROM stdin;
\.
...
COPY public.students (id, discord_id, name, created_at, updated_at) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.file_types_id_seq', 2, true);


--
-- Name: instructor_roles_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.instructor_roles_id_seq', 2, true);


--
-- Name: rag_strategies_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.rag_strategies_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.semesters_id_seq', 4, true);
...
\unrestrict xoRdvYRLqDVkLnKq1sg4jQr1ievhX9sf2aOeCTLx4ZwcSNZjoq9QeWNcp9nWAuI

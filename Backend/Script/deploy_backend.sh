...
sudo -S systemctl restart backend-coursegpt.service
sudo -S systemctl restart cybot.service 
sudo -S systemctl enable backend-coursegpt.service cybot.service
